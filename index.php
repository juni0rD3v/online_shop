    ...
    <div class="row">
        <?php
            if (isset($_POST['searchtxt']))
            {
                ...
                $q = @mysqli_query($dbc, "SELECT * FROM tbl_products WHERE clm_desc LIKE '%$searchtxt%' AND clm_quantity != 0 LIMIT 8");
            }
            else
            {
                $q = @mysqli_query($dbc, "SELECT * FROM tbl_products WHERE clm_quantity != 0 LIMIT 8");
            }
            ...
            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                <div class="list-card-image">
                    <div class="p-3">
                        ...
                        <img src="img/listing/<?php echo $row['clm_image'];?>" width="200px" class="img-fluid item-img w-50 mb-3">
            </div>
