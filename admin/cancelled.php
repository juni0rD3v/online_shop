...
<?php
    $active = 'index'; $active_sub = 'cancelled';
            ...
            <?php
                ...
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">Cancelled</h4>
                    ...
                    <div class="card-body">
                        <?php
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder, DATE_FORMAT(clm_date_cancelled, '%b %e, %Y %h:%i %p') as DateCancelled FROM tbl_orders WHERE clm_status = 5 ORDER BY clm_date DESC");
                            ...
                            else
                            {
                                echo'
                                <br><br>
                                <h4 style="color: gray">Cancelled orders will appear here.</h4><br><br><br>
                                '; 
                            }
                        ?>
                    </div>
