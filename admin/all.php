            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">All Orders</h4>
                    ...
                    <div class="card-body">
                        <?php
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder FROM tbl_orders ORDER BY clm_date DESC");
                            ...
                            else
                            {
                                echo'
                                <br><br>
                                <h4 style="color: gray">All orders will appear here.</h4>
                                '; 
                            }
                        ?>
                    </div>
