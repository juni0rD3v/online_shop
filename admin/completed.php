...
<?php
    $active = 'index'; $active_sub = 'completed';
        ...
        <div class="row">
            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                ...
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">Completed</h4>
                    <div class="pick_today shadow">
                    <div class="card">
                    <div class="card-body">
                        <?php
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder, DATE_FORMAT(clm_date_completed, '%b %e, %Y %h:%i %p') as DateCompleted FROM tbl_orders WHERE clm_status = 4 ORDER BY clm_date DESC");
                                    ...
                                    <tbody id="myTable">';
                                        while ($row = mysqli_fetch_array($q))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><button id="'.$clm_orderid.'" class="btn btn-success view_order">View</button></td>
                                            </tr>';
                                        }   
                                        echo'
                                    </tbody>
                            ...
                            else
                            {
                                echo'
                                <br><br>
                                <h4 style="color: gray">Completed orders will appear here.</h4><br><br><br>
                                '; 
                            }
                        ?>
                    </div>
