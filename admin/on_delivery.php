...
<?php
    $active = 'index'; $active_sub = 'on delivery';
...
<li class="breadcrumb-item active" aria-current="page">On Delivery Orders</li>
</ol>
</div>
</nav>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                ...
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">On Delivery Orders</h4>
                    <div class="pick_today shadow">
                    <div class="card">
                    <div class="card-body">
                        <?php
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder FROM tbl_orders WHERE clm_status = 3 ORDER BY clm_date DESC");
                                    ...
                                    <tbody id="myTable">';
                                        while ($row = mysqli_fetch_array($q))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-success"><b>'.number_format($amount, 2).'</b></td>                                         
                            ...
                            else
                            {
                                echo'
                                <br><br>
                                <h4 style="color: gray">On delivery orders will appear here.</h4>
                                '; 
                            }
                        ?>
                    </div>
