        ...
        <div class="row">
            ...
            <?php
                ...
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">Customers                                       
                    <a class="ml-auto float-right btn btn-outline-dark btn-sm" href="deleted_customers"><i class="fa fa-trash"></i> View Deleted Customers</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <?php                          
                            $q = @mysqli_query($dbc, "SELECT * FROM tbl_customers WHERE clm_status = 1 ORDER BY clm_date DESC");
                        ?>
                            ...
                            <?php                                 
                                while ($row = mysqli_fetch_array($q))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>'.$row['clm_date'].'</td>
                                        <td>
                                            <button id="'.$row['clm_customerid'].'" class="btn btn-danger delete_customer"><i class="fa fa-trash"></i> </button>
                                        </td>
                                    </tr>
                                    ';
                                }                            
