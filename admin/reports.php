...
<div class="col-lg-12 text-center shadow"id="print">
...
<nav aria-label="breadcrumb" class="breadcrumb mb-0" id="print">
<div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title"id="print">Reports
                  <button class="float-right btn btn-md btn-outline-dark" style="width:150px" type="submit" id="print" onclick="printPage()">Print</button>
                 </h4> 
                        <p class="p-2 float-right"style="color:red;">
                        <span class="text-muted">Date Prepared: </span>
                            <?php
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist" id="print">
                            <li class="nav-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-10">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-dark" type="submit" name="generate_daily">Generate</button>
                                            </div>
                                        </div>
                                        </form>                                        
                                    </div>
                                    ...
                                    <?php
                                        if (isset($_POST['generate_daily']))
                                        {
                                            ...
                                            echo '
                                            <br>
                                            <h5>DAILY LIQUIDATION REPORT
                                            <img class="float-right img-fluid logo-img " src="../images/logo_blue.png"></h5>
