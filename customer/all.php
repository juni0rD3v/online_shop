<?php
    $active = 'my_purchases'; $active_sub = 'all';
            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">All Orders</h4>
                    ...
                    <?php
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder FROM tbl_orders WHERE clm_customerid = '$CustomerID' ORDER BY clm_date DESC ");
