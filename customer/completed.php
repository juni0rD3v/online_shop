...
<?php
    $active = 'my_purchases'; $active_sub = 'completed';
        ...
        <div class="row">
            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                ...
                ?>
                    ...
                    $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder FROM tbl_orders WHERE clm_customerid = '$CustomerID' AND clm_status = 4 ORDER BY clm_date DESC ");
