<?php
    $active = 'my_purchases'; $active_sub = 'to_receive';
...
<li class="breadcrumb-item active" aria-current="page">To Recieve</li>
</ol>
</div>
</nav>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 p-4 bg-white rounded shadow-sm">
                <div class="osahan-promos">
                 <h4 class="mb-4 profile-title">To Recieve</h4>
                ...
                ?>
                    ...
                    $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y %h:%i %p') as DateOrder FROM tbl_orders WHERE clm_customerid = '$CustomerID' AND clm_status = 3 ORDER BY clm_date DESC ");
